...
#               enabled_when = "active_registration"
    ...
    reconstruction_group = Group(
        Item('tractography_mode', label="Tractography Mode",
        ...
        VGroup(
               ...
               show_border = True,
               visible_when = "diffusion_imaging_model == 'DTI'",
               enabled_when = 'tractography_mode == "streamline"',
               label = "dtk reconstruction options"
               ),
        VGroup(
               Item('bvals', label="bvals"),
               Item('bvals_file', label="bval file"),
               Item('bvecs', label="bvecs"),
               Item('bvecs_file', label="bvec file"),
               Item('eddy_correct_options', label="eddy_correct options"),
               Item('bet_options', label='bet options'),
               Item('bedpostx_options_nfibers', label='nr. of fibers'),
               Item('bedpostx_options_fudge', label='ARD fudge factor'),
               Item('bedpostx_options_nj', label='Num of jumps to be made by MCMC'),
               Item('bedpostx_options_bi', label='Total num of jumps at start of MCMC to be discarded'),
               Item('bedpostx_options_se', label='Num of jumps for each sample (MCMC)'),
               Item('bedpostx_options_upe', label='Num of jumps for each update to the proposal density std (MCMC)'),
               Item('bedpostx_options_other', label='other bedpostx options'),
               show_border = True,
               visible_when = "diffusion_imaging_model == 'DTI'",
               enabled_when = 'tractography_mode == "probabilistic"',
    ...
    tractography_group = Group(
        VGroup(
               ...
               VGroup(
                      ...
                      Item('probtrackx_options_cthrs', label="curvature threshold"),
                      Item('probtrackx_options_steplengths', label="step length in mm"),
                      Item('probtrackx_options_others', label="other options"),
                      show_border = True,
                      visible_when = "diffusion_imaging_model == 'DTI'",
                      enabled_when = "tractography_mode == 'probabilistic'",
    ...
    fiberfilter_group = Group(
        VGroup(
               ...
               VGroup(
                      ...
                      show_border = True,
                      enabled_when = ("active_fiberfilter" and "tractography_mode == 'streamline'")   
                      ),
               VGroup(
                      show_border = True,
                      visible_when = "diffusion_imaging_model == 'DTI'",
                      label = 'N.A.',
                      enabled_when = ("active_fiberfilter" and "tractography_mode == 'probabilistic")
                      ),
               ),
        ...
        VGroup(
               Item('tractography_mode', label="Tractography Mode",
                    ...
                    VGroup(
                           ...
                           show_border = True,
                           enabled_when = ("active_connectome" and "tractography_mode == 'streamline'"),
