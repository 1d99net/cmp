    ...
    tractography_group = Group(
        VGroup(
               ...
               VGroup(
                      ...
                      Item('probtrackx_options_cthr', label="curvature threshold"),
                      Item('probtrackx_options_steplength', label="step length in mm"),
                      Item('probtrackx_options_other', label="other options"),
                      show_border = True,
                      visible_when = "diffusion_imaging_model == 'DTI'",
                      enabled_when = "tractography_mode == 'probabilistic'",
