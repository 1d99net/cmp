...
#             2:[83]}
    ...
    if gconf.parcellation_scheme == "Destrieux" :
        ...
        MAPPING = [[1,11106],[2,11107],[3,11108],[4,11101],[5,11102],[6,11103],[7,11104],[8,11105],[9,11109],[10,11110],
                   [11,11111],[12,11112],[13,11113],[14,11114],[15,11115],[16,11116],[17,11117],[18,11118],[19,11119],
                   [20,11120],[21,11121],[22,11122],[23,11123],[24,11124],[25,11127],[26,11125],[27,11126],[28,11128],
                   [29,11129],[30,11130],[31,11131],[32,11132],[33,11137],[34,11138],[35,11133],[36,11134],[37,11135],
                   [38,11136],[39,11139],[40,11140],[41,11141],[42,11143],[43,11144],[44,11145],[45,11146],[46,11147],
                   [47,11148],[48,11149],[49,11150],[50,11151],[51,11152],[52,11153],[53,11154],[54,11155],[55,11156],
                   [56,11157],[57,11160],[58,11158],[59,11159],[60,11161],[61,11162],[62,11165],[63,11163],[64,11164],
                   [65,11166],[66,11167],[67,11168],[68,11169],[69,11170],[70,11171],[71,11172],[72,11173],[73,11174],
                   [74,11175],[75,10],[76,11],[77,12],[78,13],[79,26],[80,17],[81,18],[82,12106],[83,12107],[84,12108],
                   [85,12101],[86,12102],[87,12103],[88,12104],[89,12105],[90,12109],[91,12110],[92,12111],[93,12112],
                   [94,12113],[95,12114],[96,12115],[97,12116],[98,12117],[99,12118],[100,12119],[101,12120],[102,12121],
                   [103,12122],[104,12123],[105,12124],[106,12127],[107,12125],[108,12126],[109,12128],[110,12129],
                   [111,12130],[112,12131],[113,12132],[114,12137],[115,12138],[116,12133],[117,12134],[118,12135],
                   [119,12136],[120,12139],[121,12140],[122,12141],[123,12143],[124,12144],[125,12145],[126,12146],
                   [127,12147],[128,12148],[129,12149],[130,12150],[131,12151],[132,12152],[133,12153],[134,12154],
                   [135,12155],[136,12156],[137,12157],[138,12160],[139,12158],[140,12159],[141,12161],[142,12162],
                   [143,12165],[144,12163],[145,12164],[146,12166],[147,12167],[148,12168],[149,12169],[150,12170],
                   [151,12171],[152,12172],[153,12173],[154,12174],[155,12175],[156,49],[157,50],[158,51],[159,52],
                   [160,58],[161,53],[162,54],[163,16]];
    else:
...
def inspect(gconf):
    ...
    if gconf.parcellation_scheme == "NativeFreesurfer":
        ...
        for p in gconf.parcellation.keys():
            cmdstr += op.join(reg_path, p, 'ROIv_HR_th.nii.gz:colormap=lut:lut=%s ' % gconf.get_freeview_lut('Destrieux')['destrieuxaparc'])
